...
def wired():
    """
    Function that renders the wired category pitches and its content
    """
...
def new():
    ...
    if pitch_form.validate_on_submit():
        ...
        new_pitch = Pitch(title=title, body=body,author=author, category=category, upvotes=0,downvotes=0,
                          users=current_user)
